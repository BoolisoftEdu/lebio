...
class _AddNewAddressScreenState extends State<AddNewAddressScreen> {
  ...
  final TextEditingController _cityController = TextEditingController(text: 'Lomé');
  final TextEditingController _countryController = TextEditingController(text: 'Togo');
  final TextEditingController _zipCodeController = TextEditingController(text: '228');
