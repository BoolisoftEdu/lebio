...
class LocationProvider with ChangeNotifier {
  ...
  TextEditingController _locationController = TextEditingController(text: 'Je vous envoie par whatsapp');
  TextEditingController _locationController2 = TextEditingController();
  ...
  TextEditingController get locationController2 => _locationController;
  ...
  void setLocationController2(String text) {
    _locationController2.text = text;
  }
  ...
  void getCurrentLocation(BuildContext context, bool fromAddress, {GoogleMapController mapController}) async {
    ...
    if(fromAddress) {
      ...
      _locationController2.text = pickAddress.country;
    }
    _loading = false;
    notifyListeners();
  }
  ...
  void dragableAddress() async {
    ...
    _locationController.text = placeMarkToAddress(_address);
    _locationController.text =   pickAddress.country;
