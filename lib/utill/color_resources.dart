...
class ColorResources {
  ...
  static Color getColombiaBlue(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xFF336130) : Color(
        0xFF336130);
  }
  static Color getLightSkyBlue(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xFF336130) : Color(0xFF51BC87);
  }
  ...
  static Color getTextTitle(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xFF336030) : Color(0xFF51BC87);
  }
  ...
  static const Map<int, Color> colorMap = {
    50: Color(0xFF51BC87),
    100: Color(0xFF51BC87),
    200: Color(0xFF51BC87),
    300: Color(0xFF51BC87),
    400: Color(0xFF51BC87),
    500: Color(0xFF51BC87),
    600: Color(0xFF51BC87),
    700: Color(0xFF51BC87),
    800: Color(0xFF51BC87),
    900: Color(0xFF51BC87),
  };
